    ...
    <div class="site-content__wrapper">
      <div class="site-content">
        <div class="brand-info">
          ...
          <p class="brand-info__intro">footballManager基于vue、element-ui构建开发的提供给足球经理的一套解决方案</p>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      getCaptcha () {
        ...
        this.captchaPath = this.$http.adornUrl(`/api/captcha.jpg?uuid=${this.dataForm.uuid}`)
      }
    }
  }
</script>
